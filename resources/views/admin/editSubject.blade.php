...
<div class="container px-4 px-lg-5 py-lg-0">
    ...
    <form action="{{ route('updateSubject', $subjects->id)}}" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left"></form>
    @csrf
    @method("put")
    ...
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 ">
            <input type="text" id="first-name" required="required" class="form-control" name="name" value="{{ $subjects->subject }}">
        </div>
    </div>
